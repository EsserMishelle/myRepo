function openingModal() {
 ...
 function gameWon(selectedPirate) {
   ...
   const wonModalEl = document.querySelector(".won-modal");
   setTimeout(() => {
      wonModalEl.style.display = "block";
      wonModalEl.textContent = `Game over- ${selectedPirate.name} won. Click 'Restart' to play again`;
      wonModalEl.style.innerHTML = `Game over- ${selectedPirate.name} won. Click 'Restart' to play again`;
   }, 3000);
 ...
 function gameLost(selectedPirate) {
   ...
   // document.querySelector('.lost-modal-content').textContent = `Game over- ${selectedPirate.name} won. Click 'Restart' to play again`;
